      ...
      switch(c_state){
        ...
        case MENU_GESTURE:
          if(switched){
            //change musique
            this.instruction.setAttribute('opacity','1');
            document.querySelector('#morningsky').setAttribute('visible', 'true');
            //console.log("current state :" + STATES_NAMES[c_state] + " switched :"+ switched);
            switched = false;
        ...
        case MORNING:
         ...
         case MORNING_GESTURE:
          if(switched){
            ...
            //console.log("current state :" + STATES_NAMES[c_state] + " switched :"+ switched);
            switched = false;
            document.querySelector('#menusky').setAttribute('visible', 'false');
            document.querySelector('#middaysky').setAttribute('visible', 'true');
        ...
        case MIDDAY_GESTURE:
          if(switched){
            ...
            switched = false;
            this.instruction.setAttribute('opacity','1');
            document.querySelector('#morningsky').setAttribute('visible', 'false');
            document.querySelector('#stormsky').setAttribute('visible', 'true');
        ...
        case STORM:
          ...
          if(switched){
            ...
            this.instruction.setAttribute('opacity','1');
            switched = false;
            document.querySelector('#middaysky').setAttribute('visible', 'false');
            document.querySelector('#sunsetsky').setAttribute('visible', 'true');
        ...
        case SUNSET_GESTURE:
          if(switched){
            ...
            switched = false;
            this.instruction.setAttribute('opacity','1');
            document.querySelector('#stormsky').setAttribute('visible', 'false');
            document.querySelector('#nightsky').setAttribute('visible', 'true');
            this.gestureChecker.oldZ = document.querySelector('a-entity[camera]').getAttribute('rotation').z;
